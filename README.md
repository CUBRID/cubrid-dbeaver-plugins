...
The **cubrid-dbeaver-plugins** develops plugins and tools to enhance [CUBRID](https://github.com/CUBRID/cubrid) support within [DBeaver](https://github.com/dbeaver/dbeaver) and [Cloudbeaver](https://github.com/dbeaver/cloudbeaver/).
...
you can easily activate CUBRID using the provided script. For detailed instructions, please refer to the [README](cubrid-enabler-cloudbeaver/README.md).